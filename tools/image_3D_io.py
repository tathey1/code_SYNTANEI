...
IMAGE_SUFFIXES = ['.jpg', '.jpeg', '.tiff', '.bmp', '.png']
...
def save_image_3d(image_3d, image_save_root, dim = 0, suffix = '.tiff'):
    ...
    for index in range(image_3d.shape[dim]):
        image_full_name = os.path.join(image_save_root, str(index).zfill(6)) + suffix
        cv2.imwrite(image_full_name, image_3d[index])
